# -*- coding: utf-8 -*-
#
# SnapGene Tools documentation build configuration file, created by
...
version = snapgene_tools.__version__
# The full version, including alpha/beta/rc tags.
release = snapgene_tools.__version__
...
man_pages = [
    ('index', 'cookiecutterproject_name', u'SnapGene Tools Documentation',
     [u'Kale Kundert'], 1)
]
